...
const HomePage = () => (
  <div className='home-page'>
    <div className='welcome-content'>
      <h1>Welcome</h1>
      <p>Welcome to 'A Uniquely Inspired Life'! We are a unique online retail store that offers lifestyle, home decor and garden products. 
...
We offer free shipping on any U.S. order over $100.</p>
    </div>
    {/* <BlogsPreview /> */}
  </div>
);
